...
class SpotDetailViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        default:
            print("*** Error, did not have a segue in prepare for segue")
        }
    }
...
extension SpotDetailViewController: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .restricted:
            showAlert(title: "Location services denied", message: "It may be that parently controls are restricting location use in this app")
        }
    }
...
extension SpotDetailViewController: UINavigationControllerDelegate, UIImagePickerControllerDelegate{
    ...
    func accessCamera() {
        if UIImagePickerController.isSourceTypeAvailable(.camera) {
            ...
            showAlert(title: "Camera not avail", message: "there is no camera on this device")
        }
    }
}
